...
<body>
    ...
    <!-- Tambahan If-Else Berdasarkan Input Nama dan Jenis Kelamin -->
    <h2>Menampilkan Pesan Berdasarkan Nama dan Jenis Kelamin</h2>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($gender == "laki-laki") {
            echo "<p>Selamat datang, Pak $name!</p>";
        } elseif ($gender == "perempuan") {
            echo "<p>Selamat datang, Ibu $name!</p>";
        }
    }
    ?>
    <hr>
    ...
    <h2>6. Hyperlink</h2>
    <a href="https://www.instagram.com/r.valdo /" target="_blank">Kunjungi instagram Saya</a>
    <br>
